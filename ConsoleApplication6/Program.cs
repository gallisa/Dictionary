...
namespace ConsoleApplication6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ReplacehebTextTogim(@"C:\Users\gb250153\Downloads\WhoAmI\WhoAmI2.txt", @"C:\Users\gb250153\Downloads\WhoAmI\WhoAmI3.txt");
        ...
        private static void ReplacehebTextTogim(string textFile, string gimFile)
        {
        ...
        private static void extractheb(string originalengFile, string outputhebFile)
        {
            string ch;
            string tempLine;
